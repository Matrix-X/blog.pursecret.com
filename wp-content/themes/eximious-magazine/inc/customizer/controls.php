 ...
 */
class Eximious_Magazine_Dropdown_Taxonomies_Control extends WP_Customize_Control {
    ...
    <label>
        ...
        $dropdown_args = wp_parse_args( $this->dropdown_args, array(
            ...
            'show_option_none'  => __( '&mdash; Select &mdash;', 'eximious-magazine' ),
            'selected'          => $this->value(),
            'show_option_all'   => '',
            'orderby'           => 'id',
            'order'             => 'ASC',
 ...
 * @see WP_Customize_Control
 */
class Eximious_Magazine_Radio_Image_Control extends WP_Customize_Control {
 ...
 * @access public
 */
class Eximious_Magazine_Customize_Section_Upsell extends WP_Customize_Section {
