...
<form name="registerform" id="registerform" action="<?php echo esc_url( site_url( 'wp-login.php?action=register', 'login_post' ) ); ?>" method="post" novalidate="novalidate">
    ...
    <p>
        <label for="user_email"><?php _e('Password') ?><br />
            <input type="password" name="user_password" id="user_password" class="input" value="<?php echo esc_attr( wp_unslash( $user_password ) ); ?>" size="25" /></label>
    </p>
	<?php
	/**
